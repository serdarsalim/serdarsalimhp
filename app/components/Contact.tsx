...
export default function Contact() {
  return (
    <section id="contact" className="relative py-16 md:py-32 bg-gradient-to-b from-orange-50 to-teal-50">
      <div className="max-w-4xl mx-auto px-4 md:px-6">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl p-6 md:p-12 border border-teal-200">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 md:gap-8">
            ...
            <a
              ...
              className="group flex items-center gap-3 text-gray-600 hover:text-gray-900 transition-colors justify-center"
            >
